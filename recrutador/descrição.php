...
?>
<div class="row">
	<h5 class="center-align"><?php echo $dados['nome_vaga'];?><a href="../recrutador/editar_vaga.php?id=<?php echo $dados['idvagas'];?>" class="btn-floating grey darken-3"><i class="material-icons">edit</i></a> <a href="#modal<?php echo $dados['idvagas'];?>" class="btn-floating red modal-trigger"><i class="material-icons">delete</i></a></h5>
...
<h5>Informações da Vaga</h5>
		...
		<h6 class="left-align">Local:</h6>
		<p style="font-size: 20px" class="left-align"><?php echo $dados['local'];?></p>
		<div class="divider"></div>
